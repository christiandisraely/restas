...
<div class="modal fade" id="agregarClienteModal" tabindex="-1" aria-labelledby="agregarClienteModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <img src="{{ asset('images/43573_clients_icon (1).png') }}" alt="Imagen del Modal" class="img-fluid"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="DPI" class="form-label">DPI (PDF)</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="Patente" class="form-label">Patente (PDF)</label>
                                <input type="file" class="form-control" id="Patente" name="Patente">
                            </div>
                            <div class="mb-3">
                                <label for="RTU" class="form-label">RTU (PDF)</label>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="Municipio" name="Municipio" required>
                                    ...
                                    <!-- Municipios para cada departamento -->
